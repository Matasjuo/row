...
A single `<h1 class="dash-title">Matas Dashboard</h1>` at the very top of the body. Styled as:
...
- The page opens with a gradient `Matas Dashboard` headline at the top.
